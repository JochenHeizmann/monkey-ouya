...
class BBAndroidGame extends BBGame implements GLSurfaceView.Renderer,SensorEventListener{
	...
	public static class GameView extends GLSurfaceView{
		...
		public boolean onKeyUp ( int key,KeyEvent event ){
            ...
            if (handled) {
                _androidGame.KeyEvent( BBGameEvent.KeyUp, sendKey );
                return true;
            }
		...
		public boolean onKeyDown( int key,KeyEvent event ){
            ...
            if (handled) {
                _androidGame.KeyEvent( BBGameEvent.KeyDown, sendKey );
                return true;
            }
...
class AndroidGame extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i( "[Monkey]",new String("Activity->OnCreate()") );
    ...
    @Override
    public void onStart() {
        Log.i( "[Monkey]",new String("Activity->OnStart()") );
        super.onStart();
    }
    ...
    public void initOuyaFacade(String developerId) {
